  ...
  <div class="flex items-center justify-between py-3">
    <div class="flex gap-3">
      <div class="relative" @click="toggleFilterDropdown">
        <div
          class="flex items-center px-2 py-1 gap-1 border border-[#EAEAEB] rounded-lg cursor-pointer"
        >
          <Icon
        ...
        <div
          ...
          class="absolute top-full left-0 mt-1 bg-white border border-[#EAEAEB] rounded-lg shadow-md"
        >
    ...
    <div class="flex gap-2 items-center">
      <div
        class="bg-[#2C55FB] rounded-md flex justify-center items-center px-3 py-1 gap-2 cursor-pointer"
